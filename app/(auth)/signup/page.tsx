  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        const needsResumeUpload = formData.role === "freelancer";
        if (needsResumeUpload) {
          localStorage.setItem("pending_resume_upload", "freelancer");
        }

        // Freelancers: after email verification (if required) go to resume upload; otherwise go directly
        ...
        <div className="mx-auto w-full max-w-md space-y-10">
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Get started by creating a new account. Faster onboarding, clearer guidance, and polished UI.
            </p>
          </div>
