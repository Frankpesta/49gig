      ...
      <div className="w-full space-y-6">
        ...
        <div className="space-y-3.5">
          <button
            ...
            className="w-full group relative overflow-hidden rounded-lg border border-border/50 bg-background/50 p-4.5 text-left transition-all duration-200 hover:border-primary/40 hover:bg-primary/5 hover:shadow-md"
          >
