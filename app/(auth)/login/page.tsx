  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success && result.refreshToken) {
        ...
        setRefreshToken(result.refreshToken);
        // Store session token if needed (in localStorage or secure storage)
        if (result.sessionToken) {
        ...
        <div className="space-y-6 max-w-md">
          <div className="space-y-4">
            <h2 className="text-3xl font-bold tracking-tight">
              Welcome back to 49GIG
            </h2>
            <p className="text-lg text-muted-foreground">
              Connect with vetted freelancers and trusted clients in a high-trust marketplace.
            </p>
          </div>
          ...
          <div className="space-y-4 pt-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold">Vetted Talent Pool</h3>
                <p className="text-sm text-muted-foreground">
                  All freelancers undergo comprehensive verification
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Escrowed payments with milestone-based releases
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Algorithmic matching for perfect project-fit
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto w-full max-w-md space-y-10">
          ...
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-4 py-2 text-sm font-semibold text-primary">
              ...
              Trusted access to the 49GIG network
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-foreground">
              Welcome back
            </h1>
            <p className="text-muted-foreground leading-relaxed">
              Sign in to your account to continue. Secure, minimal friction, and built for speed.
            </p>
          </div>
