    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "49GIG freelance platform hero",
      },
    ],
  },
  twitter: {
    ...
    <div className="w-full">
        ...
        <div className="relative z-10 px-4 pb-20 pt-24 sm:px-6 sm:pt-28 lg:px-8 lg:pt-36">
          <div className="mx-auto w-full max-w-5xl">
            <div className="mx-auto flex max-w-2xl flex-col items-center text-center lg:mx-0 lg:max-w-3xl lg:items-start lg:text-left">
              <h1 className="text-5xl font-bold leading-[1.08] tracking-tight text-[#0a0a0a] sm:text-6xl sm:leading-[1.05] lg:text-7xl lg:leading-[1.02] dark:text-white">
                <span className="block">Hire world-class</span>
                <span className="block">tech talent</span>
                <span className="mt-1 block text-[#C4920A] dark:text-[#E6A80A]">rigorously vetted,</span>
                <span className="block text-[#C4920A] dark:text-[#E6A80A]">ranked and delivery-ready.</span>
              </h1>

              <p className="mt-8 max-w-xl text-lg leading-relaxed text-[#3f3f3f] sm:text-xl dark:text-zinc-300">
      ...
      >
          ...
          <SectionTransition variant="fade" delay={200}>
            <div className="mx-auto mb-14 max-w-3xl text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-base text-muted-foreground sm:text-lg">
                From Africa to Canada, here's how companies across the globe are solving their toughest hiring challenges.
              </p>
            </div>
          </SectionTransition>
        </div>
        ...
        <div className="relative mt-2">
          <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-24 bg-linear-to-r from-background to-transparent sm:w-36" />
          <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-24 bg-linear-to-l from-background to-transparent sm:w-36" />

          <div className="overflow-hidden">
            <ul
              className="flex w-max gap-6 py-4 animate-marquee-slow"
              aria-label="Scrolling case studies"
            >
              {(() => {
                const studies = [
                  {
                    ...
                    overview: "A Lagos-based fintech needed a backend engineer in days, not weeks. 49GIG delivered a vetted match in under 72 hours.",
                    challenge: ["No internal engineering team", "Needed to start quickly", "Couldn't afford long recruitment cycles"],
                    solution: { intro: "49GIG matched them with a vetted backend engineer within days.", points: ["Pre-vetted talent — no CV filtering needed", "Optional interview after matching", "Escrow-secured engagement"] },
                    result: ["Engineer onboarded in under 72 hours", "MVP development started immediately", "Weeks of hiring time saved"],
                    quote: "49GIG removed the hiring friction completely. We focused on building instead of recruiting.",
                  },
                  {
                    number: "02",
                    flag: "🇰🇪",
                    ...
                    overview: "A Nairobi startup needed senior engineers to scale without blowing their runway. 49GIG provided two vetted engineers at a fraction of local cost.",
                    challenge: ["High cost of senior local engineers", "Slow hiring pipeline", "Need for reliable long-term talent"],
                    solution: { intro: "49GIG provided part-time and full-time engineers across backend and cloud.", points: ["Rigorous vetting already done", "Monthly engagement model", "Secure escrow payments"] },
                    result: ["2 engineers onboarded in 1 week", "Significant cost reduction", "Faster product iteration"],
                    quote: "We got senior-level output at a fraction of the cost, without compromising quality.",
                  },
                  {
                    number: "03",
                    flag: "🇨🇦",
                    ...
                    overview: "Tubira AI needed a vetted professional without drowning in unqualified applications. 49GIG's pre-screening did all the heavy lifting.",
                    challenge: ["Hundreds of unqualified applicants", "No time for lengthy interviews", "Needed strong technical + communication skills"],
                    solution: { intro: "49GIG provided pre-vetted engineering talent ready to perform.", points: ["Technical screening already completed", "Communication and experience evaluated", "Optional interview after matching"] },
                    result: ["Candidate matched in days", "Smooth onboarding", "Strong performance from week one"],
                    quote: "We reduced our engineering costs significantly without compromising on quality.",
                  },
                  {
                    number: "04",
                    flag: "🇨🇦",
                    ...
                    overview: "Cabwire was skeptical of remote hiring. 49GIG matched them with talent that integrated quickly and delivered beyond expectations.",
                    challenge: ["Skepticism around remote team integration", "Previous bad experience with unvetted hires", "Needed fast team culture alignment"],
                    solution: { intro: "49GIG activated its talent matching and onboarding support system.", points: ["Immediate talent reassignment if needed", "Ongoing project monitoring", "Structured kickoff and integration support"] },
                    result: ["Talent integrated in the first week", "Delivered beyond initial expectations", "Client now fully committed to remote hiring"],
                    quote: "We were skeptical about remote hiring at first, but 49GIG made it seamless.",
                  },
                ];
                return [...studies, ...studies].map((cs, i) => {
                  const BadgeIcon = cs.badge.icon;
                  const isPrimary = cs.badge.color === "primary";
                  return (
                  <li
                    key={i}
                    aria-hidden={i >= studies.length ? true : undefined}
                    className="w-[500px] shrink-0 relative overflow-hidden rounded-2xl border border-border/55 bg-background/95 shadow-sm ring-1 ring-border/20"
                  >
                    <span
                      className="pointer-events-none absolute right-5 top-3 select-none text-[5rem] font-black leading-none text-foreground/[0.04]"
                      aria-hidden
                    >
                      {cs.number}
                    </span>
                    ...
                    <div className="relative p-7">
                      ...
                      <div className="mb-5 flex flex-wrap items-start gap-3">
                        <div className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-semibold ${isPrimary ? "border-primary/25 bg-primary/10 text-primary" : "border-secondary/40 bg-secondary/10 text-secondary-foreground"}`}>
                      ...
                      <h3 className="mb-2 text-xl font-bold text-foreground">{cs.title}</h3>
                      <p className="mb-6 text-sm leading-relaxed text-muted-foreground">{cs.overview}</p>

                      {/* Challenge / Solution / Result — stacked */}
                      <div className="space-y-3">
                        <div className="rounded-xl border border-border/50 bg-muted/25 p-4">
                          <div className="mb-3 flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-wide text-orange-600 dark:text-orange-400">Challenge</span>
                          </div>
                          <ul className="space-y-1.5">
                            {cs.challenge.map((point, pi) => (
                              <li key={pi} className="flex items-start gap-2">
                                <span className="mt-1.5 h-1 w-1 shrink-0 rounded-full bg-orange-400" />
                                <span className="text-xs leading-snug text-foreground/80">{point}</span>
                              </li>
                            ))}
                          </ul>
                        </div>
                        ...
                        <div className="rounded-xl border border-primary/20 bg-primary/5 p-4">
                          <div className="mb-3 flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-wide text-primary">Solution</span>
                          </div>
                          <p className="mb-2 text-xs leading-snug text-foreground/80">{cs.solution.intro}</p>
                          <ul className="space-y-1.5">
                        ...
                        <div className="rounded-xl border border-green-200/60 bg-green-50/40 p-4 dark:border-green-900/40 dark:bg-green-950/20">
                          <div className="mb-3 flex items-center gap-2">
                            <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-green-500/10">
                              <TrendingUp className="h-3 w-3 text-green-600 dark:text-green-400" />
                            </div>
                            <span className="text-[10px] font-bold uppercase tracking-wide text-green-700 dark:text-green-400">Result</span>
                          </div>
                          <ul className="space-y-1.5">
                      ...
                      {/* Quote */}
                      <div className="mt-5 flex items-start gap-3 rounded-xl border border-border/40 bg-muted/20 px-5 py-4">
                        <div className={`mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg ${isPrimary ? "bg-primary/10" : "bg-secondary/15"}`}>
                          <Quote className={`h-3.5 w-3.5 ${isPrimary ? "text-primary" : "text-secondary-foreground"}`} />
                        </div>
