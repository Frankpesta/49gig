...
import { parseTipTapDocJson } from "@/lib/blog/tiptap-doc";
...
/** Server-side TipTap JSON -> HTML render, used so blog post content ships in the initial SSR payload. */
export function renderBlogContentHtml(contentJson: string): string {
  try {
...
export const blogContentProseClassNames = [
