    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 bg-transparent p-0 hover:bg-accent hover:text-accent-foreground border-border/50"
        ),
        ...
        head_row: "flex mb-2",
        head_cell:
          "text-muted-foreground rounded-md w-10 font-medium text-[0.8rem] flex items-center justify-center",
